...
async def lifespan(app: FastAPI):
    ...
    await seed_departments(async_session_maker, app.state.kafka_producer)
    await seed_grades(async_session_maker, app.state.kafka_producer)
    await seed_skills(async_session_maker, app.state.kafka_producer)
    ...
    await seed_demo_leads(async_session_maker, app.state.kafka_producer)
...
async def health_check():
    return {"status": "ok", "service": "management_service"}
