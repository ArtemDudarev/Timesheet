...
from src.kafka.topics import EMPLOYEE_PROFILE_CREATED_TOPIC, EMPLOYEE_UPDATED_TOPIC
from src.kafka.handlers import handle_employee_profile_created, handle_employee_updated
...
class KafkaEventConsumer:
    def __init__(self) -> None:
        ...
        self.group_id = os.getenv("KAFKA_GROUP_ID", "document-service")
